...
TRAIN_DIR = Path("../../processed/trial5/sim2/10k/whole/train_weekly")
TEST_DIR  = Path("../../processed/trial5/sim2/10k/whole/test_weekly")

OUT_TRAIN_DIR = Path("../../processed/trial5/sim2/10k/whole/scaled_global/train_weekly")
OUT_TEST_DIR  = Path("../../processed/trial5/sim2/10k/whole/scaled_global/test_weekly")

SCALER_PATH = Path("../../processed/trial5/sim2/10k/whole/scaled_global/robust_scaler.joblib")
